...
class DoublyLinkedListArrayInvalidIndexException extends \Exception{}

class DoublyLinkedListArray implements \Iterator, \Countable
{
	...
	public function current<T>() : T
	{
		if ($this->pointer === null || !$this->dllData->containsKey($this->pointer)) {
			throw new DoublyLinkedListArrayInvalidIndexException();
		}
